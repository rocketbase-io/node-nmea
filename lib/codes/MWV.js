...
exports.Encoder = function (id) {
    ...
    this.encode = function (id, data) {
        ...
        a.push(Helper.encodeDegrees(data.apparent_wind_angle));
        a.push(Helper.encodeValue(data.reference));
        a.push(Helper.encodeFixed(data.apparent_wind_speed, 1));
        a.push(Helper.encodeValue(data.units));
